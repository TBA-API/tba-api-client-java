...
public class ZebraTeam {
   ...
   * @return teamKey
  **/
  @ApiModelProperty(example = "frc7332", required = true, value = "The TBA team key for the Zebra MotionWorks data.")
   ...
   * @return xs
  **/
  @ApiModelProperty(required = true, value = "A list containing doubles and nulls representing a teams X position in feet at the corresponding timestamp. A null value represents no tracking data for a given timestamp.")
   ...
   * @return ys
  **/
  @ApiModelProperty(required = true, value = "A list containing doubles and nulls representing a teams Y position in feet at the corresponding timestamp. A null value represents no tracking data for a given timestamp.")
