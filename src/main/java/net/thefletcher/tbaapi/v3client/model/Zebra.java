...
public class Zebra {
  ...
  **/
   ...
   * @return times
  **/
  @ApiModelProperty(required = true, value = "A list of relative timestamps for each data point. Each timestamp will correspond to the X and Y value at the same index in a team xs and ys arrays. `times`, all teams `xs` and all teams `ys` are guarenteed to be the same length.")
